...
values(seq_user.nextval,'admin','6f9b0a55df8ac28564cb9f63a10be8af6ab3f7c2',2,1);
...
select o.*,(select count(1) from VoteItem where voId=o.voId ) voteCount from VOTEOPTION o where vsid = 103
